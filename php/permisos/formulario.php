...
<div class="container-fluid bg-white my-2 py-3">
  <div class="col-md-4 mx-auto">
    <form id="formPermisosAdd" onsubmit="event.preventDefault();">
      ...
      <input type="text" class="form-control form-control-sm mb-2" data-validate name="dias">
      <label class="mb-1">Observaciones</label>
      <input type="text" class="form-control form-control-sm mb-2" data-validate name="observacion">
      <div class="text-end">
