            ...
            <ul>
                ...
                <li class="sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu">
                        <ul>
                            <!-- <li><a href="/gyt/vistas/plantillas/equipo/lista_familia.php" id="">Familias</a></li> -->
                            
                            <li><a href="#" id="listaFamiliaEquipos">Agregar Equipo</a></li>
                            <li><a href="#" id="getionEquipos">Gestión</a></li>
                            <li class="sidebar-dropdown-child">
                                ...
                                <div class="sidebar-submenu-child" style="display: none;">
                                    <ul>
                                        <li><a href="#" id="docEquipo">ingreso</a></li>
                                        <li><a href="#" id="gestionDocEquipos">Gestión</a></li>
                                        <li><a href="#" id="enviosMasivosDoc">Envios masivos</a></li>
                                    </ul>
                                </div>
                            </li>
                            <li class="sidebar-dropdown-child">
                                <a href="#"><span class="menu-text2">Imagenes</span> </a>
                                <div class="sidebar-submenu-child" style="display: none;">
                                    <ul>
                                        <li><a href="#" id="imgEquipo">ingreso</a></li>
                                        <li><a href="#" id="gestionImgEquipos">Gestión</a></li>
                                    </ul>
                                </div>
                            </li>
                            <li><a href="#" id="btn-scan-qr" onclick="encenderCamara()" data-bs-toggle="modal" data-bs-target="#modalCamaraQR">Reconocimiento QR</a></li>
                        </ul>
                    </div>
                </li>
                <li class="sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu">
                        ...
                        <!-- <li><a href="#" id="IndexEquipos">Index equipos</a></li> -->
                        <li><a href="#" id="EquipoContrato" onclick="reducirSidebarlateral()">Consola</a></li>
                        </ul>
                    </div>
                </li>
